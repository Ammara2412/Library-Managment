...
class UserRepositoryTest {
    ...
    void testSaveUser_success() {
        ...
        userregister savedUser = userRepository.save(user);
    ...
    void testFindByEmail_success() {
        ...
        Optional<userregister> foundUser = userRepository.findByEmail("john.doe@example.com");
    ...
    void testFindByEmail_userNotFound() {
        ...
        Optional<userregister> foundUser = userRepository.findByEmail("unknown@example.com");
